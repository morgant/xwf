...
#define TOPWIN	2
	...
	menu_entry dir_mlist[] = {
		...
		{ _("Close Window"),	cb_destroy,TOPWIN, GDK_w, GDK_CONTROL_MASK},
		{ NULL,				NULL,			0},
		...
		{ _("Go to Parent Folder"),		cb_go_up,		0, GDK_BackSpace},
		{ _("Go to Home Folder"),			cb_go_home,		0, GDK_h, GDK_SHIFT_MASK|GDK_CONTROL_MASK},
		{ _("Select all"),		cb_select,		0, GDK_a, GDK_CONTROL_MASK},
		{ _("Deselect"),	cb_unselect,0,GDK_a, GDK_SHIFT_MASK|GDK_CONTROL_MASK},
		{ _("Find..."),		cb_find,		0, GDK_f, GDK_CONTROL_MASK},
		{ _("Show/Hide Dotfiles"),on_dotfiles,0,GDK_d, GDK_SHIFT_MASK|GDK_CONTROL_MASK},
		{ NULL,					NULL,			0},
		{ _("Get Info..."),cb_props, 		0, GDK_i, GDK_CONTROL_MASK},
		{ NULL,				NULL,			0},
	...
	menu_entry file_mlist[] = {
		...
		{ _("Move to Trash..."),		cb_delete,		0, GDK_BackSpace, GDK_CONTROL_MASK},
		{ _("Duplicate"),		cb_duplicate,	0, GDK_d, GDK_CONTROL_MASK},
		{ NULL,					NULL,			0},
		{ _("Open Trash"),			cb_open_trash,WINCFG, GDK_t, GDK_CONTROL_MASK},
		{ _("Empty Trash..."),		cb_empty_trash,	0, GDK_BackSpace, GDK_SHIFT_MASK|GDK_CONTROL_MASK},
		{ NULL,					NULL,			0},
		...
		{ NULL,					NULL,			0},
		{ _("Get Info..."),	cb_props,		0, GDK_i, GDK_CONTROL_MASK},
		{ _("Register..."),	cb_register,	0, GDK_j, GDK_CONTROL_MASK},
		{ NULL,					NULL,			0},
		{ _("Run Command..."),		cb_exec, 		WINCFG, GDK_r, GDK_SHIFT_MASK|GDK_CONTROL_MASK},
		{ NULL,					NULL,			0},
		{ _("About..."),			cb_about,	0},
	...
	menu_entry mixed_mlist[] = {
		{ _("Open in New Windows"),		cb_new_window,	0, GDK_n, GDK_CONTROL_MASK},
		{ _("Close Window"),		cb_destroy, 0, GDK_w, GDK_CONTROL_MASK},
		{ NULL,					NULL,			0},
		{ _("Move to Trash..."),			cb_delete,	0, GDK_BackSpace, GDK_CONTROL_MASK},
		{ NULL,					NULL,			0},
		{ _("Open Trash"),			cb_open_trash,WINCFG, GDK_t, GDK_CONTROL_MASK},
